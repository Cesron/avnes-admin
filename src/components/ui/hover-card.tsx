...
function HoverCardContent({
  ...
  return (
    <HoverCardPrimitive.Portal>
      ...
      >
        {children}
        <HoverCardPrimitive.Arrow className="bg-popover fill-popover z-50 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rounded-[2px] border-r border-b border-border" />
      </HoverCardPrimitive.Content>
    </HoverCardPrimitive.Portal>
  );
}
