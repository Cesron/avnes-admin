...
import { useEditActivityForm } from "../_hooks/use-edit-activity-form";
...
export function EditActivityForm({ groupsOptions }: EditActivityFormProps) {
  const { isOpen, closeEditDialog } = useEditActivity();
  const { form, onSubmit, loading } = useEditActivityForm();
        ...
        <form id="form-edit-activity" onSubmit={form.handleSubmit(onSubmit)}>
          <FieldGroup>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor="form-edit-activity-name">
                    Nombre de la Actividad
                  </FieldLabel>
                  <Input
                    {...field}
                    id="form-edit-activity-name"
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel htmlFor="form-edit-activity-description">
                    Descripción (opcional)
                  </FieldLabel>
                  <Textarea
                    {...field}
                    id="form-edit-activity-description"
                    aria-invalid={fieldState.invalid}
              ...
              render={({ field }) => (
                <Field>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <Checkbox
                      id="form-edit-activity-recurring"
                      checked={field.value}
                      onCheckedChange={field.onChange}
                    />
                    <FieldLabel htmlFor="form-edit-activity-recurring">
            ...
            {!isRecurring && (
              <>
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="form-edit-activity-single-date">
                        Fecha
                      </FieldLabel>
                      <Input
                        {...field}
                        type="date"
                        id="form-edit-activity-single-date"
                        aria-invalid={fieldState.invalid}
                      />
                      {fieldState.invalid && (
                        <FieldError errors={[fieldState.error]} />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="form-edit-activity-single-start-time">
                          Hora de inicio
                        </FieldLabel>
                        <Input
                          {...field}
                          type="time"
                          id="form-edit-activity-single-start-time"
                          aria-invalid={fieldState.invalid}
                        />
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="form-edit-activity-single-end-time">
                          Hora de fin
                        </FieldLabel>
                        <Input
                          {...field}
                          type="time"
                          id="form-edit-activity-single-end-time"
                          aria-invalid={fieldState.invalid}
                        />
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
            ...
            {isRecurring && (
              <>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="form-edit-activity-frequency">
                        Frecuencia
                      </FieldLabel>
                      <Select
                        value={field.value}
                      ...
                      >
                        <SelectTrigger
                          id="form-edit-activity-frequency"
                          aria-invalid={fieldState.invalid}
                        >
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="form-edit-activity-interval">
                        Intervalo
                      </FieldLabel>
                      <Input
                        {...field}
                        type="number"
                        min={1}
                        id="form-edit-activity-interval"
                        aria-invalid={fieldState.invalid}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="form-edit-activity-start-date">
                          Fecha de inicio
                        </FieldLabel>
                        <Input
                          {...field}
                          type="date"
                          id="form-edit-activity-start-date"
                          aria-invalid={fieldState.invalid}
                        />
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        ...
                        <Input
                          {...field}
                          type="date"
                          id="form-edit-activity-end-date"
                          aria-invalid={fieldState.invalid}
                        />
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="form-edit-activity-start-time">
                          Hora de inicio
                        </FieldLabel>
                        <Input
                          {...field}
                          type="time"
                          id="form-edit-activity-start-time"
                          aria-invalid={fieldState.invalid}
                        />
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="form-edit-activity-end-time">
                          Hora de fin
                        </FieldLabel>
                        <Input
                          {...field}
                          type="time"
                          id="form-edit-activity-end-time"
                          aria-invalid={fieldState.invalid}
                        />
                        {fieldState.invalid && (
                          <FieldError errors={[fieldState.error]} />
